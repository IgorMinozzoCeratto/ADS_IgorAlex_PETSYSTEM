...
('Admin User', 'admin', 'senha_criptografada_admin', 'admin@petsystem.com', '2023-01-01', NULL, (SELECT id FROM perfil WHERE nome = 'ADMINISTRADOR')),
('João Silva', 'joao', 'senha_criptografada_joao', 'joao@petsystem.com', '2023-01-15', NULL, (SELECT id FROM perfil WHERE nome = 'FUNCIONARIO')),
('Dr. Carlos Santos', 'carlos', 'senha_criptografada_carlos', 'carlos@petsystem.com', '2023-01-10', 'CRMV-RS 12345', (SELECT id FROM perfil WHERE nome = 'VETERINARIO'));
